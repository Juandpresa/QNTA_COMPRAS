...
namespace MVCCompras.Controllers
{
    public class ReferenciaBancariasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ReferenciaBancariaID,ProveedorID,BancoID,MonedaID,Nombre,Cuenta,Clabe,EstaActivo")] ReferenciaBancaria referenciaBancaria)
        {
