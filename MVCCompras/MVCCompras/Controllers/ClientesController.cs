...
namespace MVCCompras.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ClienteID,RazonSocial,RFC,Calle,NumeroExterior,NumeroInterior,Colonia,Alcaldia,Estado,EstaActivo")] Cliente cliente)
        {
